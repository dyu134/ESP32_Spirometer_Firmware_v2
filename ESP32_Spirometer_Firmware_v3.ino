    ...
    if (hasData) {
      if (localData.valid) {
        ...
        if (deviceConnected) {
          ...
          Serial.println();
          String data1 = "s " + String(localData.x1, 2) + " x1 " + String(localData.z1, 2) + " z1";
          String data2 = "s " + String(localData.x2, 2) + " x2 " + String(localData.z2, 2) + " z2";
          String dataY = "s " + String(localData.y1, 2) + " y1 " + String(localData.y2, 2) + " y2";
